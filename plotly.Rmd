...
count(rest_inspec_sample, cuisine_description) #85 types
...
This scatterplot contains observations of Manhattan entities that received a grade (A, B, or C) in 2017. There are 1,894 observations. 
